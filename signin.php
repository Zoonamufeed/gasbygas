                            ...
                            <form action="includes/login_sub.php" method="POST" class="signin-form">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="password" name="password" style="border-radius:2rem;" class="form-control password" placeholder="Password" required>
                                ...
                                <div class="form-group d-md-flex">
                                    ...
                                    <div class="w-50 text-md-right">
                                        <a href="otprequest.php">Forgot Password</a>
                                    </div>
                                </div>
                            </form>
                        </div>
